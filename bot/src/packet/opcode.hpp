...
enum class Opcode : uint16_t {
  ...
  kFrameworkMessageIdentify = 0x2001, // LOGIN_CLIENT_INFO, LOGIN_SERVER_INFO, CLIENT_INFO, SERVER_INFO
  ...
  kClientGatewayShardListRequest = 0x6101,
  kClientGatewayShardListPingRequest = 0x6106,
  ...
  kServerGatewayPatchResponse = 0xA100,
  ...
  kClientAgentSkillMasteryLearnRequest = 0x70A2,
  kClientAgentSkillLearnRequest = 0x70A1,
