...
const TypeCategory kItem{static_cast<uint8_t>(3)};
  const TypeCategory kEquipment{kItem.subCategory(1)};
    ...
    const TypeCategory kShield{kEquipment.subCategory(4)};
      const TypeCategory kChineseShield{kShield.subCategory(1)};
      const TypeCategory kEuropeanShield{kShield.subCategory(2)};
    ...
    const TypeCategory kEquipmentAvatar{kEquipment.subCategory(13)};
      const TypeCategory kAvatarHat{kEquipmentAvatar.subCategory(1)};
      const TypeCategory kAvatarDress{kEquipmentAvatar.subCategory(2)};
      const TypeCategory kAvatarAccessory{kEquipmentAvatar.subCategory(3)};
