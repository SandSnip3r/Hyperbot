...
extern const TypeCategory kItem;
  extern const TypeCategory kEquipment;
    ...
    extern const TypeCategory kEquipmentAvatar;
      extern const TypeCategory kAvatarHat;
      extern const TypeCategory kAvatarDress;
      extern const TypeCategory kAvatarAccessory;
