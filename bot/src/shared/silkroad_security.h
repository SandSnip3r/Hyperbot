...
struct PacketContainer {
  ...
  PacketContainer(uint16_t packet_opcode,
                  ...
                  Clock::time_point packet_timestamp = Clock::now());
  PacketContainer(const PacketContainer &rhs);
  PacketContainer(PacketContainer &&rhs) noexcept;
  PacketContainer &operator=(const PacketContainer &rhs);
  PacketContainer &operator=(PacketContainer &&rhs) noexcept;
  ~PacketContainer();
};
...
public:
  ...
  void Recv(const uint8_t *stream,
            int32_t count,
