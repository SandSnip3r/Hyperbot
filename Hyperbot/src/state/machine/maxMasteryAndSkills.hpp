...
public:
  ...
  void initialize(const pk2::SkillData &skillData, pk2::ref::MasteryId masteryId, uint8_t masteryLevel, const std::vector<sro::scalar_types::ReferenceSkillId> &knownSkillIds);
...
public:
  MaxMasteryAndSkills(Bot &bot, pk2::ref::MasteryId id);
