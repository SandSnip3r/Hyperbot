#ifndef SRO_PK2_READER_H_
#define SRO_PK2_READER_H_
...
public:
	...
	void SetDecryptionKey(const char * ascii_key = "169841", uint8_t ascii_key_length = 6, const char * base_key = "\x03\xF8\xE4\x44\x88\x99\x3F\x64\xFE\x35", uint8_t base_key_length = 10);
