...
CharacterSelectionActionPacketBuilder::CharacterSelectionActionPacketBuilder(packet::enums::CharacterSelectionAction action) :
...
PacketContainer ClientMovementRequestPacketBuilder::packet() const {
  ...
  if (hasDestination_) {
    ...
    clientMovementRequestPacketData.Write<uint8_t>(static_cast<uint8_t>(packet::enums::AngleAction::kGoForward));
...
ServerChatPacketBuilder::ServerChatPacketBuilder(packet::enums::ChatType chatType, const std::string &message) :
...
ServerChatPacketBuilder::ServerChatPacketBuilder(packet::enums::ChatType chatType, uint32_t senderId, const std::string &message) :
      PacketBuilder(Opcode::SERVER_CHAT),
      chatType_(chatType),
      senderId_(senderId),
      message_(message) {
...
ServerChatPacketBuilder::ServerChatPacketBuilder(packet::enums::ChatType chatType, const std::string &senderName, const std::string &message) :
      PacketBuilder(Opcode::SERVER_CHAT),
      chatType_(chatType),
...
PacketContainer ServerChatPacketBuilder::packet() const {
  ...
  if (chatType_ == packet::enums::ChatType::kAll ||
      chatType_ == packet::enums::ChatType::kAllGm ||
      chatType_ == packet::enums::ChatType::kNpc) {
    serverChatPacketData.Write<uint32_t>(senderId_);
  } else if (chatType_ == packet::enums::ChatType::kPm ||
             chatType_ == packet::enums::ChatType::kParty ||
             chatType_ == packet::enums::ChatType::kGuild ||
             chatType_ == packet::enums::ChatType::kGlobal ||
             chatType_ == packet::enums::ChatType::kStall ||
             chatType_ == packet::enums::ChatType::kUnion ||
             chatType_ == packet::enums::ChatType::kAcademy) {
