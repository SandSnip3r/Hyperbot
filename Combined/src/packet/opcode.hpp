...
enum class Opcode {
  ...
  LOGIN_CLIENT_PATCH_REQUEST = 0x6100, // LOGIN_CLIENT_PATCH_REQUEST, CLIENT_PATCH_REQUEST
  ...
  CLIENT_PATCH_REQUEST = 0x6100, // LOGIN_CLIENT_PATCH_REQUEST, CLIENT_PATCH_REQUEST
  ...
  kClientAgentCharacterSelectionActionRequest_STATE = 0x704F,
